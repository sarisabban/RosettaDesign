...
from rosetta.protocols.denovo_design.movers import *
from rosetta.core.pack.task import *
from rosetta.core.scoring.packstat import *
...
def SASA(pose):
	...
	#Boundary:	Helix or Sheet: 15 < SASA < 60		Loop: 25 < SASA < 40
...
class Design():
	...
	def Pack(pose):
		...
		for identity in layers:								#Loop through each layer
			...
			MC.recover_low(pose)							#True - at the end of application, the pose is set to the lowest (or highest if sample_type="high") scoring pose
